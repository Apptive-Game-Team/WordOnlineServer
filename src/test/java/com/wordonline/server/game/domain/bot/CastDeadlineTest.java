...
class CastDeadlineTest {
    ...
    // A ceiling on silence, not a floor on frequency. The bot is kept weak by what it may summon,
    // not by how often, so a cast may follow the one before it immediately.
    @Test
