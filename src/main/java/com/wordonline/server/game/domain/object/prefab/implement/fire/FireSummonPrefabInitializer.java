...
public class FireSummonPrefabInitializer extends PrefabInitializer {
    ...
    public void initialize(GameObject gameObject) {
        var buildParameters = parameters.object(GameObjectKey.FIRE_SUMMON);
        ...
        gameObject.getComponents().add(new Spawner(gameObject, buildParameters.intValue(ParameterKey.HP), PrefabType.FireSlime));
    }
}
