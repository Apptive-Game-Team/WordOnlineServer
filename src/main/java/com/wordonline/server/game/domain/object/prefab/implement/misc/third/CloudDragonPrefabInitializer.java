...
import com.wordonline.server.game.domain.object.component.mob.statemachine.attacker.CloudDragonMob;
...
public class CloudDragonPrefabInitializer extends PrefabInitializer {
    ...
    public void initialize(GameObject gameObject) {
        ...
        gameObject.addComponent(new CloudDragonMob(gameObject,
                ...
                cloudDragonParameters.floatValue(ParameterKey.CHAIN_LIGHTNING_COOLDOWN)
        ));
        gameObject.setElement(EnumSet.of(ElementType.WATER, ElementType.WIND, ElementType.LIGHTNING));
