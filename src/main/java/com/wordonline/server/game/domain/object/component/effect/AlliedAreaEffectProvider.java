...
public class AlliedAreaEffectProvider extends Component {
    ...
    public AlliedAreaEffectProvider(GameObject gameObject, float interval, float radius, Effect effect) {
        super(gameObject);
