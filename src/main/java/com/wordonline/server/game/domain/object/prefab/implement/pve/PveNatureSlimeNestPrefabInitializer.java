...
public class PveNatureSlimeNestPrefabInitializer extends PrefabInitializer {
    ...
    public PveNatureSlimeNestPrefabInitializer(Parameters parameters, DatabaseMagicParser magicParser) {
    ...
    public void initialize(GameObject gameObject) {
        gameObject.addComponent(new RigidBody(gameObject, (int) parameters.getValue("pve_nature_slime_nest", "mass")));
        ...
        List<Magic> magics = resolveMagics("nature_slime_swarm");
